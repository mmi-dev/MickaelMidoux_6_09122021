...
function mediaFactory(data) {
  ...
  let thumbName // nom du fichier de la vignette
  ...
  let imageUrl = ''
  if (image) {
    imageUrl = `assets/photographers/resized/${photographerId}/${image}`
  } else if (video) {
    imageUrl = `assets/photographers/${photographerId}/${video}`
  }
  ...
  function getMediaCardDOM() {
    ...
    if (image) {
      medialink.setAttribute('class', 'media__link image')
      medialink.setAttribute('data-lightbox', 'image')
    } else if (video) {
      medialink.setAttribute('class', 'media__link video')
      medialink.setAttribute('data-lightbox', 'video')
    }
    // photo thumbnail
